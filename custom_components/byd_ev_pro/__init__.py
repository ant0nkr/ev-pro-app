...
async def _handle_webhook(
    ...
    # HMAC verification — only include config in response if signature is valid.
    ...
    if webhook_secret:
        ...
        signature_valid = hmac.compare_digest(expected, received)
    else:
        # No secret configured — treat as valid (not yet set up).
